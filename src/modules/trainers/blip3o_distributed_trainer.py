...
FIXES:
- Proper import paths for communication utilities
- Better error handling for imports
- Fixed communication utilities imports
"""
...
# Import communication utilities (FIXED)
from src.modules.distributed.communication import (
    DistributedCommunicator,
    MetricsAggregator,
    log_distributed_info
...
class BLIP3oDistributedTrainer:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Distributed communication (FIXED)
        self.communicator = DistributedCommunicator(rank, world_size)
        self.metrics_aggregator = MetricsAggregator(rank, world_size)
